package com.palfed.android.menu.activities.customviews;
...
import com.palfed.android.menu.activities.adapter.ListAdapterFooter;


/**
 * Created by Android QTS on 5/9/2016.
 */
public class HorizontalScrollviewCustom extends HorizontalScrollView {
    ...
    public void setAdapter(Context context, ListAdapterFooter mAdapter) {
    ...
    private void fillViewWithAdapter(ListAdapterFooter mAdapter)
